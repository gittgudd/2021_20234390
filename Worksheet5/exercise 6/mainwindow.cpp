...
//connect( ui->actionSave, &QAction::triggered, this, &MainWindow::handleMenuSave );
...
void QAction::actionSave() {
emit statusUpdateMessage( QString("Save button was clicked"), 0 );
}